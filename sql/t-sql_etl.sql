...
# Check the conversion ok and the record is free of error
...
-- Examine the current table structure
SELECT * FROM OrderDetailTable_v1;
...
-- Because the data has been copied, so truncate the table fiest
Truncate Table OrderDetailTable_v2;

-- Update the RecNo into a sequence number.  i.e. 1,2,3,4,5,6,7,....
-- And Insert other data as well
